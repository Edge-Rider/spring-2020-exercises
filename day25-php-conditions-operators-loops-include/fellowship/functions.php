<?php
  function leave_hobbiton($party){
    $party = array_merge($party, ['merry' => 'Meriadoc Brandybuck','pippin' => 'Peregrin Took']);
    return $party;
    };
    ...
    function go_to_weathertop($party){
      $party = array_merge($party, ['Witch King of Angmar','Nazgûl #2','Nazgûl #3', 'Nazgûl #4', 'Nazgûl #5', 'Nazgûl #6','Nazgûl #7','Nazgûl #8','Nazgûl #9']) ;
      return $party;
    }
    ...
    function break_fellowship($party){
      ...
      $hunting_party = [
        'strider' => $party['strider'],
        'legolas' => $party['legolas'],
        'gimli' => $party['gimli']
      ];
